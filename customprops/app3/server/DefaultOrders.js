...
var custPropsSchema = {
  Markasurgent : getCustomProperty('bool', 'Mark as urgent', 0, 0, 1, []),
  Districtid : getCustomProperty('int', 'Distric Id', 1, 1, 1, arrInt1to5),
  Districtname : getCustomProperty('ddlist', 'Distrct Name', 'District-1', 'District-1', getArrayWithPrefix('District', 5)),
  ...
  Corporationid : getCustomProperty('ddlist', 'Corporation Id', 1, 1, arrInt1to5),
  ...
  Inventorytype : getCustomProperty('ddlist', 'Inventory Type', 1, 1, arrInt1to5),
  ...
  Subaccountnumberid : getCustomProperty('int', 'Sub Account Number Id', 1, 1, 1, arrInt1to5),
  ...
  ProjectActivitycodeid : getCustomProperty('int', 'Project/Acivity Code Id', 1, 1, 1, arrInt1to5),
  ...
  Accountcategoryid : getCustomProperty('int', 'Account Category Id', 1, 1, 1, arrInt1to5),
